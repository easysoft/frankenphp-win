...
ZEND_BEGIN_ARG_INFO_EX(arginfo_headers_send, 0, 0, 0)
...
ZEND_BEGIN_ARG_INFO(arginfo_frankenphp_finish_request, 0)
ZEND_END_ARG_INFO()

// #define arginfo_fastcgi_finish_request arginfo_frankenphp_finish_request

ZEND_BEGIN_ARG_INFO(arginfo_fastcgi_finish_request, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(arginfo_frankenphp_request_headers, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(arginfo_getallheaders, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(arginfo_frankenphp_response_headers, 0)
ZEND_END_ARG_INFO()
